...
RDBMS is the relational database and SQL is the language that you use with the database

1. Why do tables need a `primary key`?

primary key is needed in every table to establish relationships wiht outher tables
...
we need to have 3 tables to facilitate a many to many relationship.
